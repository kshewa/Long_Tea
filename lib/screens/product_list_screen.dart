...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 150, // Slightly increased width for better proportions
      height: 220, // Increased height to accommodate larger image
      ...
      child: Column(
        ...
        children: [
          ...
          Stack(
            children: [
              Container(
                height: 120, // Increased from 80 to 120 for better visibility
